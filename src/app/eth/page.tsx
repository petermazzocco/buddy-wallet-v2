...
import NFTs from "../components/ETH/NFTs";
...
export const metadata: Metadata = {
  title: "ETHEREUM - BUDDY WALLET",
  description: "Ethereum Buddy Wallet",
};
        ...
        <div className="hero-content text-center">
          <div className="max-w-full mx-10 grid justify-center place-items-center align-middle">
            ...
            <Image
              ...
              height={50}
              src={
                "https://cryptologos.cc/logos/versions/ethereum-eth-logo-diamond.svg?v=025"
              }
              alt="logo"
              className="py-5"
            />
